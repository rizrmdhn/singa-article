...
import { users, authentications, articles, roles, role_permissons, permissions, auth_access_tokens, conversation_transcripts, conversation_nodes, static_translations, static_transcripts, conversation_translations, sessions } from "./schema";
...
export const role_permissonsRelations = relations(role_permissons, ({one}) => ({
	role: one(roles, {
...
export const auth_access_tokensRelations = relations(auth_access_tokens, ({one}) => ({
	user: one(users, {
...
export const conversation_transcriptsRelations = relations(conversation_transcripts, ({one}) => ({
	user: one(users, {
...
export const conversation_nodesRelations = relations(conversation_nodes, ({one, many}) => ({
	conversation_transcripts: many(conversation_transcripts),
...
export const static_translationsRelations = relations(static_translations, ({one, many}) => ({
	user: one(users, {
...
export const static_transcriptsRelations = relations(static_transcripts, ({one}) => ({
...
export const conversation_translationsRelations = relations(conversation_translations, ({one, many}) => ({
	user: one(users, {
