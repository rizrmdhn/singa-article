...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="from-blue-primary via-blue-secondary to-blue-tertiary flex h-fit min-h-screen w-full flex-col items-center justify-end gap-5 bg-gradient-to-br px-2 text-white md:gap-20"
    >
      <section className="mt-28 flex flex-col items-center gap-4">
        ...
        <div className="my-5 flex w-full items-center justify-center md:mt-10">
          <a
            ...
            target="_blank"
            className="focus:shadow-outline text-blue-tertiary mr-6 inline-flex h-12 items-center justify-center rounded bg-white px-6 font-medium tracking-wide shadow-md transition duration-200 hover:bg-gray-200 focus:outline-none"
          >
            Download
          </a>
          <a
